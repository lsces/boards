...
$gBitInstaller->registerPackageInfo( BOARDS_PKG_NAME, [
...
// ### Indexes
$indices = [
	'boards_id_idx' => [ 'table' => 'boards', 'cols' => 'board_id', 'opts' => null ],
];
$gBitInstaller->registerSchemaIndexes( BOARDS_PKG_NAME, $indices );

// ### Sequences
$sequences = [
	'boards_board_id_seq' => [ 'start' => 1 ],
	'boards_sections_id_seq' => [ 'start' => 1 ],
];
$gBitInstaller->registerSchemaSequences( BOARDS_PKG_NAME, $sequences );

// ### Default UserPermissions
$gBitInstaller->registerUserPermissions( BOARDS_PKG_NAME, [
	[ 'p_boards_admin' , 'Can admin message boards'  , 'admin'  , BOARDS_PKG_NAME ],
	[ 'p_boards_create', 'Can create a message board', 'editors', BOARDS_PKG_NAME ],
	...
	[ 'p_boards_read'  , 'Can read message boards'   , 'basic'  , BOARDS_PKG_NAME ],
	[ 'p_boards_remove', 'Can delete message boards' , 'editors', BOARDS_PKG_NAME ],
] );
